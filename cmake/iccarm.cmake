...
find_program(CMAKE_C_COMPILER NAMES iccarm iccarm)
find_program(CMAKE_CXX_COMPILER NAMES iccarm iccarm)
find_program(CMAKE_ASM_COMPILER NAMES iasmarm iasmarm)
...
find_program(CMAKE_AR NAMES iarchive iarchive )
find_program(CMAKE_CXX_COMPILER_AR NAMES iarchive iarchive)
find_program(CMAKE_C_COMPILER_AR NAMES iarchive iarchive)
endif()

#SET(CMAKE_LINKER "${tools}/bin/arm-none-eabi-g++")
find_program(CMAKE_LINKER NAMES ilinkarm ilinkarm)
